    ...
    <>
      <div className="flex min-h-screen bg-gray-100">
        <div className="w-[100%] min-h-screen p-4 sm:p-6   bg-gray-100">
          ...
          items-start sm:items-center mb-6 gap-3 ">
                ...
                
              {
                creatorCourseData?.map((course,index)=>(
                  ...
                  <td className="py-3 px-4 flex items-center gap-4">
                    {course?.thumbNail ? <img src={course.thumbNail} 
                    className="w-14 h-14 object-cover rounded-md object-fit"
                      alt="" /> 
                    :<img src={img}
                    className="w-14 h-14 object-cover rounded-md object-fit" alt="" />}
                  ...
                  <td className={`py-3 px-4`}>
                    ...
                    ${course.isPublished ? 'bg-red-100 text-green-600' : 'bg-red-100 text-red-600'} `}>
